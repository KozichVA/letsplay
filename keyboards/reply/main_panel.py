...
main_panel = ReplyKeyboardMarkup(resize_keyboard=True,
                                 ...
                                 keyboard=[[KeyboardButton(text='Ближайшие события'),
                                            KeyboardButton(text='Коллекция Игр')],
...
main_panel_admin = ReplyKeyboardMarkup(resize_keyboard=True,
                                       ...
                                       keyboard=[[KeyboardButton(text='Ближайшие события'),
                                                 ...
                                                 [KeyboardButton(text='Создать событие'),
                                                  KeyboardButton(text='Назначить мастера')],
                                                 [KeyboardButton(text='Добавить ролевуху'),
                                                  KeyboardButton(text='Добавить настолку')],
                                                 [KeyboardButton(text='Сделать рассылку'),
                                                  KeyboardButton(text='Утвердить роли')]])
